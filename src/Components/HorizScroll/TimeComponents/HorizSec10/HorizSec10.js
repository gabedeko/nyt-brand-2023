...
import TimePlaceholder from '../../../../assets/time_video_placeholder.png';
...
useEffect(() => {
  ...
  function timeupdate() {
      ...
      if ((sum >= 15) && !reported50percent) {
         
          reported50percent = true;
          window.report_time_50_percent();
          
      }
      if ((sum >= 30) && !reported100percent) {
  ...
  return (
    <div className={styles.HorizSec10} id="HorizSec10">
      <div className={styles.HorizSec10Content}>
        ...
        <ViewportVideo
          onEnterViewport={() => window.module_02_sub_time()} 
        />
