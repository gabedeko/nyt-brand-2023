...
import BrandVideoSnkrs from '../../../../assets/YNYT0409000H_NYT_Understanding_Sneakers_60_Landing_Page.mp4';
  ...
  return (
    <div className={styles.MobileSlide13} id="MobileSlide13" onScroll={handleScroll}>
      <div className={styles.MobileSlide13Top}>
        <h2 className={styles.SneakersIntroMsg} >More of life brought to life.</h2>
        ...
        onPlay={TrackPlay}
        >
          <source src={BrandVideoSnkrs} type="video/mp4"/>
        </video>

        <div className={styles.MobileSlide13More}>
          <h2 className={styles.SneakersIntroMsgBtm} onClick={() => window.location.reload(false)}>Back to the start</h2>
