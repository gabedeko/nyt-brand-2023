...
import GravityVideo from '../../../../assets/YNYT0412000H_NYT_Understanding_Gravity_60_Landing_Page.mp4';
  ...
  return (
    <div className={styles.MobileSlide13} id="MobileSlide13" onScroll={handleScroll}>
      <div className={styles.MobileSlide13Top}>
        <h2 className={styles.GravityIntroMsg} >More of life brought to life.</h2>
        ...
        <div className={styles.MobileSlide13More}>
          <h2 className={styles.GravityIntroMsgBtm} onClick={() => window.location.reload(false)}>Back to the start</h2>
